...
(function($) {
    $.fn.galleryView = function(options) {
        ...
        function showItem(i) {
            ...
            $('span.nav-next').unbind('click');
            $('span.nav-prev').unbind('click');
                ...
                if (opts.fade_panels) {
                    ...
                    j_panels.fadeOut(opts.transition_speed).eq(i % item_count).fadeIn(opts.transition_speed, function() {
                        if (!has_filmstrip) {
                            ...
                            $('span.nav-prev').click(showPrevItem);
                            $('span.nav-next').click(showNextItem);
                        }
                    });
                }
            }
        ...
        function buildPanels() {
            ...
            j_panels.css({
                ...
                'background':'white',
                'display':'none',
                'border': opts.panel_border,
                'padding': opts.panel_padding + 'px'
            });
        ...
        function buildFilmstrip() {
            ...
            j_filmstrip.css({
                'listStyle':'none',
                'margin':'0',
                'padding': opts.strip_padding + 'px',
                'width':strip_width + 'px',
                'position':'absolute',
                'zIndex':'900',
                'top':'0',
                'left': filmstrip_left + 'px',
            ...
            $('.strip_wrapper', j_gallery).css({
                'position':'absolute',
                'top':(opts.filmstrip_position == 'top' ? '0px' : opts.panel_height + (2 * opts.panel_padding) + opts.panel_bottom_margin + 'px'),
                'left':0,
                ...
                'overflow':'hidden',
                'border': opts.strip_border,
                'padding': opts.strip_padding + 'px',
                'background': opts.strip_background
            });
